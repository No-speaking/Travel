	...
	<div class="container-fluid content">
		...
		<div class="main ">
			...
			<div class="col-sm-6 col-md-4">
                <div class="thumbnail">
                  <img data-src="holder.js/100%x200" alt="100%x200" src="show.action?scenicname=${sm.scenicname }" data-holder-rendered="true" style="height: 200px; width: 100%; display: block;">
                  <div class="caption">
                    <h3>${sm.scenicname }</h3>
                    <p> ${sm.scenicintr}.</p>
                    <p><s:text name="ticket"/>: ${sm.scenicticket}</p>
                    <p><s:text name="opentime"/>: ${sm.scenictime}</p>
                  </div>
                </div>
            </div>
            <div class="col-md-4">
					...
					<div class="panel panel-default">
						<div class="row">
                            <div class="col-md-4">
                              ...
                              <div class="col-sm-6 col-md-4">
                                <div class="thumbnail">
                                  <img src="assets/img/avatar.jpg" alt="景点" width="242px" height="200px">
                                  <div class="caption">
                                    <h3>Thumbnail label</h3>
                                    <p>kjsidfjiaieuiofwsfijdsnknvfksdnifuieuaop
                                        fkdjskfnkdnvjgdnjfhaiewhiohfodsh</p>
