...
<body>
	...
	<div class="container-fluid content">
		...
		<div class="main sidebar-minified">
			...
			<div class="row">
				<div class="col-lg-12">
					<h3 class="page-header"><i class="fa fa-table"></i>订单</h3>
					<ol class="breadcrumb">
						<li><i class="fa fa-home"></i><a href="index.html">主页</a></li>			  	
						<li><i class="fa fa-table"></i>订单</li>				
					</ol>
				</div>
			</div>
				...
				<div class="col-lg-12">
					<div class="panel panel-default">
						<div class="panel-heading">
							<h2><i class="fa fa-table red"></i><span class="break"></span><strong>订单</strong></h2>
						...
						<div class="panel-body">
							<table class="table table-striped table-bordered bootstrap-datatable datatable">
							  ...
							  <tbody>	
							  <c:forEach var="oml" items="${oml}">	 							
								<tr>
									<td> ${oml.ordersno}</td>
                                    <td> ${oml.ordersprice}</td>
                                    <td> ${oml.orderscount}</td>
                                    <td> ${oml.ordersname}</td>
                                    <td> ${oml.ordersid}</td>
                                    <td> ${oml.orderstell}</td>
									<td>
										<span class="label label-warning">${oml.orderdate}</span>
									</td>
									<td>
										<a class="btn btn-success" href="tovieworder.action?ordersno=${oml.ordersno}">
											<i class="fa fa-search-plus "></i>                                            
										</a>
										<a class="btn btn-info" href="tomodifyorder.action?ordersno=${oml.ordersno }">
											<i class="fa fa-edit "></i>                                            
										</a>
										<a class="btn btn-danger" href="todeleteorder.action?ordersno=${oml.ordersno }">
                            ...
                            <ul class="pagination">
								<li><a href="tomainorder.action?page=${page-1}">上一页</a></li>
								<li class="active">
								  <a href="tomainorder.action?page=1">1</a>
								</li>
								<li><a href="tomainorder.action?page=2">2</a></li>
								<li><a href="tomainorder.action?page=3">3</a></li>
								<li><a href="tomainorder.action?page=${page+1}">下一页</a></li>
							  </ul>     
						</div>
					</div>
				</div><!--/col-->
