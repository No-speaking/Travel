			    ...
			    <div class="col-md-6">
			        <div class="panel panel-default">
			            <div class="panel-heading">
			                <h2><i class="fa fa-indent red"></i><strong>修改路线</strong></h2>
			            </div>
			            <form action="modifyroad.action" method="post" class="form-horizontal ">
						<div class="panel-body">
							
				                
				                <div class="form-group">
				                    <label class="col-md-3 control-label" for="text-input">路线名称</label>
				                    <div class="col-md-9">
				                        <input type="text" id="text-input" name="rm.routename" class="form-control" placeholder="Text" value="${rm.routename}" readonly="readonly">
                                ...
                                <div class="form-group">
				                    ...
				                    <div class="col-md-9">
				                        <textarea id="textarea-input" name="rm.routeintro" rows="9" class="form-control" placeholder="Content..">${rm.routeintro}</textarea>
				                    </div>
				                </div>
                                
				                <div class="form-group">
				                    <label class="col-md-3 control-label" for="email-input">天数</label>
				                    <div class="col-md-9">
				                        <input type="text" id="email-input" name="rm.routeday" class="form-control" placeholder="Email address" value="${rm.routeday}">
				                        <span class="help-block">Please enter your email</span>
				                    </div>
				                </div>
                                <div class="form-group">
				                    <label class="col-md-3 control-label">景点</label>
				                    <div class="col-md-9">
				                        <s:checkboxlist label="景点" name="routeTypeNos" list="sml" listKey="scenicname" listValue="scenicname" value="%{scenics}"></s:checkboxlist>
				                    </div>
				                </div>
                                
				                <div class="form-group">
				                    <label class="col-md-3 control-label" for="password-input">价格</label>
				                    <div class="col-md-9">
				                        <input type="text" id="password-input" name="rm.routeprice" class="form-control" placeholder="Password" value="${rm.routeprice}">
				                        <span class="help-block">Please enter a complex password</span>
				                    </div>
				                </div>
                                
                                <div class="form-group">
									<label class="col-md-3 control-label" for="select">交通方式</label>
									<div class="col-md-9">
										<select id="select" class="form-control"  name="rm.routetraffic">
