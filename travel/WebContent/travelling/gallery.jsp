...
<body>
	...
	<div class="container-fluid content">
		...
		<div class="main ">
			...
			<div class="row">
				<div class="col-lg-12">
					<h3 class="page-header"><i class="fa fa-picture-o"></i>Gallery</h3>
					<ol class="breadcrumb">
				...
				<div class="col-lg-12">
					<div class="panel panel-default">
						<div class="panel-heading" data-original-title>
							<h2><i class="fa fa-picture-o red"></i><strong>Gallery</strong></h2>
						...
						<div class="panel-body">
							...
							<div class="row">
									...
									<img class="img-thumbnail" src="assets/img/gallery/photo13.jpg" alt="Sample Image">
																...
																<div style="margin-bottom:30px" class="col-md-4">
									<img class="img-thumbnail" src="assets/img/gallery/photo14.jpg" alt="Sample Image">
								</div>
																<div style="margin-bottom:30px" class="col-md-4">
									<img class="img-thumbnail" src="assets/img/gallery/photo15.jpg" alt="Sample Image">
								</div>
															</div>
						</div>	
					</div><!--/col-->
