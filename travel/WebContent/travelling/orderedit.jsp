			    ...
			    <div class="col-md-6">
			        <div class="panel panel-default">
			            <div class="panel-heading">
			                <h2><i class="fa fa-indent red"></i><strong>修改订单</strong></h2>
			            </div>
			            	<form action="modifyorder" method="post"  class="form-horizontal ">
						<div class="panel-body">
                                ...
                                <div class="form-group">
									...
									<div class="col-md-9">
										<select id="select" class="form-control" name="om.orderscount">
								        	<option value="0" selected="${ om.orderscount==0}?'selected':''">请选择</option>
				                            <option value="1" selected="${ om.orderscount==1}?'selected':''">1</option>
				                            <option value="2" selected="${ om.orderscount==2}?'selected':''">2</option>
				                            <option value="3" selected="${ om.orderscount==3}?'selected':''">3</option>
                                            <option value="4" selected="${ om.orderscount==4}?'selected':''">4</option>
                                            <option value="5" selected="${ om.orderscount==6}?'selected':''">6</option>
                                            <option value="7" selected="${ om.orderscount==7}?'selected':''">7</option>
                                            <option value="8" selected="${ om.orderscount==8}?'selected':''">8</option>
                                            <option value="9" selected="${ om.orderscount==9}?'selected':''">9</option>
                                            <option value="10" selected="${ om.orderscount==10}?'selected':''">10</option>
								      	</select>
								    </div>
								</div>
				                <div class="form-group">
				                    ...
				                    <div class="col-md-9">
				                        <input type="text" id="email-input"  class="form-control" placeholder="Email address" value="${ om.ordersprice}" name="om.ordersprice">
				                        <span class="help-block">Please enter your email</span>
				                    </div>
				                </div>
				                <div class="form-group">
				                ...
				                <div class="form-group">
				                    <label class="col-md-3 control-label" for="select">路线</label>
				                    <div class="col-md-9">
				                 
				                 <s:select label="部门" id="select" cssClass="form-control" name="om.route.routename" list="rml" listKey="routename" listValue="routename"  theme="simple"/>
