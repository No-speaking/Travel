			    ...
			    <div class="col-md-6">
			        <div class="panel panel-default">
			            <div class="panel-heading">
			                <h2><i class="fa fa-indent red"></i><strong>修改景点</strong></h2>
			            </div>
			            <form action="modifyscenic.action" method="post" enctype="multipart/form-data" class="form-horizontal ">
						<div class="panel-body">
				                ...
				                <div class="form-group">
				                    ...
				                    <div class="col-md-9">
				                        <input type="text" id="text-input" name="sm.scenicname" class="form-control" value="${sm.scenicname }" readonly="readonly">
                                ...
                                <div class="form-group">
				                    ...
				                    <div class="col-md-9">
				                        <textarea id="textarea-input" name="sm.scenicintr" rows="9" class="form-control" placeholder="Content..">${sm.scenicintr }</textarea>
				                    </div>
				                </div>
				                ...
				                <div class="form-group">
				                    ...
				                    <div class="col-md-9">
				                        <input type="text" id="email-input" name="sm.scenicticket" class="form-control" placeholder="Email address" value="${sm.scenicticket }">
				                ...
				                <div class="form-group">
				                    ...
				                    <div class="col-md-9">
				                        <input type="text" id="password-input" name="sm.scenictime" class="form-control" placeholder="Password" value="${sm.scenictime }">
				                 ...
				                 <div class="form-group">
				                    ...
				                    <div class="col-md-9">
				                        <img data-src="holder.js/100%x200" alt="100%x200" src="show.action?scenicname=${sm.scenicname }" id="file-show"  data-holder-rendered="true" style="height: 200px; width: 100%; display: block;">
				                    </div>
				                </div>
                                
                                <div class="form-group">
				                    <label class="col-md-3 control-label" for="file-input">修改图片</label>
				                    <div class="col-md-9">
