			    ...
			    <div class="col-md-6">
			        <div class="panel panel-default">
			            <div class="panel-heading">
			                <h2><i class="fa fa-indent red"></i><strong>增加路线</strong></h2>
			            </div>
			            <s:form action="addroute.action" method="post" enctype="multipart/form-data" cssClass="form-horizontal " theme="simple">
						<div class="panel-body">
				                ...
				                <div class="form-group">
				                    ...
				                    <div class="col-md-9">
				                        <s:textfield name="rm.routename" cssClass="form-control" theme="simple"/>
                                ...
                                <div class="form-group">
				                    ...
				                    <div class="col-md-9">
				                        <s:textarea name="rm.routeintro" cssClass="form-control" theme="simple" ></s:textarea>
				                    </div>
				                </div>
				                ...
				                <div class="form-group">
				                    ...
				                    <div class="col-md-9">
				                        <s:textfield  name="rm.routeday" cssClass="form-control" theme="simple"/>
				                        <span class="help-block">Please enter your email</span>
				                    </div>
				                </div>
                                <div class="form-group">
				                    <label class="col-md-3 control-label">景点</label>
				                     <!-- <s:checkboxlist name="routeTypeNos" list="sml" listKey="scenicname" listValue="scenicname" theme="simple"></s:checkboxlist>-->
				                ...
				                <div class="form-group">
				                    ...
				                    <div class="col-md-9">
				                        <s:textfield name="rm.routeprice" cssClass="form-control" id="password-input" theme="simple"/>
						...
						<div class="panel-footer">
		                    <!-- <s:submit cssClass="btn btn-sm btn-success"></s:submit>-->
