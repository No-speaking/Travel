			    ...
			    <div class="col-md-6">
			        <div class="panel panel-default">
			            <div class="panel-heading">
			                <h2><i class="fa fa-indent red"></i><strong>增加订单</strong></h2>
			            </div>
			            <s:form action="addorder.action" method="post"  cssClass="form-horizontal " theme="simple">
						<div class="panel-body">
				                ...
				                <div class="form-group">
				                    ...
				                    <div class="col-md-9">
				                       <s:textfield name="om.ordersname" cssClass="form-control" theme="simple"/>
				                ...
				                <div class="form-group">
				                    ...
				                    <div class="col-md-9">
				                        <s:textfield name="om.ordersid" cssClass="form-control" theme="simple"/>
				                ...
				                <div class="form-group">
				                    ...
				                    <div class="col-md-9">
				                        <s:textfield name="om.orderstell" cssClass="form-control" theme="simple"/>
				                ...
				                <div class="form-group">
				                    ...
				                    <div class="col-md-9">
				                        <s:textfield name="om.ordersprice" cssClass="form-control" theme="simple"/>
				                        <span class="help-block">Please enter your email</span>
				                    </div>
				                </div>
				                <div class="form-group">
				                    ...
				                    <div class="col-md-9">
				                        ...
				                        <s:textfield name="om.orderdate" cssClass="form-control" theme="simple"/>
				                        <span class="help-block">Please enter a complex password</span>
				                    </div>
				                </div>
				                ...
				                <div class="form-group">
				                    ...
				                    <div class="col-md-9">
				                 <select class="form-control" name="om.route.routename" >
				  				  	<c:forEach var="rml" items="${rml}">
				     				 <option value="${rml.routename }">${rml.routename }</option>
								    </c:forEach>
				  				  </select>
				  				  </div>
				                </div>
