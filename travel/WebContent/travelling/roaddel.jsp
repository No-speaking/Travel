			    ...
			    <div class="col-md-6">
			        <div class="panel panel-default">
			            <div class="panel-heading">
			                <h2><i class="fa fa-indent red"></i><strong>删除路线</strong></h2>
			            </div>
			            <form action="deleteroad.action" method="post" class="form-horizontal ">
						<div class="panel-body">
				                ...
				                <div class="form-group">
				                    ...
				                    <div class="col-md-9">
				                        <input type="text" id="text-input" name="rm.routename" class="form-control" placeholder="Text" value="${rm.routename}">
                                ...
                                <div class="form-group">
									...
									<div class="col-md-9">
				                        <input type="text" id="select" name="rm.routetraffic" class="form-control" placeholder="Password" value="${rm.routetraffic}">
				                        <span class="help-block">Please enter a complex password</span>
				                    </div>
								</div>
