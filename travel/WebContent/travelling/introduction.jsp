...
<div class="container-fluid content">
		...
		<div class="main ">
			...
			<div class="row">
				<div class="col-lg-12">
					<h3 class="page-header"><i class="fa fa-columns"></i>Pricing Tables</h3>
					<ol class="breadcrumb">
						<li><i class="fa fa-home"></i><a href="index.html">Home</a></li>
						<li><i class="fa fa-file-text"></i><a href="#">Pages</a></li>
						<li><i class="fa fa-columns"></i>Pricing Tables</li>				
					</ol>
				</div>
			</div>
			...
			<div class="row">
				...
				<div class="price-table">	
					...
					<div class="price-table four">
						...
						<div class="plan">
							<ul>
								<li class="header red-bg">BASIC</li>								
								<li class="price">$125.23</li>								
								...
								<li class="select"><a class="btn btn-success" href="page-pricing-tables.html#">Buy Now</a></li>
							</ul>
						</div>	
						
						<div class="plan">
							<ul class="discount">
								<div class="label label-warning">DISCOUNT 70%</div>
								<li class="header red-bg">STANDART</li>								
								<li class="price">$250.86</li>
								<li>PREMIUM PROFILE LISTING</li>
                                <li>UNLIMITED FILE ACCESS</li>
                                <li>FREE APPOINTMENTS</li>
								<li>UNLIMITED DISK SPACE</li>
						...
						<div class="plan">
							<ul>								
								<li class="header red-bg">PREMIUM</li>								
								<li class="price">$326.99</li>
								<li>PREMIUM PROFILE LISTING</li>
                                <li>UNLIMITED FILE ACCESS</li>
                                <li>FREE APPOINTMENTS</li>
								<li>UNLIMITED DISK SPACE</li>
						...
						<div class="plan">
							<ul>
								<li class="header red-bg">PROFESSIONAL</li>								
								<li class="price">$500.89</li>
								<li>PREMIUM PROFILE LISTING</li>
                                <li>UNLIMITED FILE ACCESS</li>
                                <li>FREE APPOINTMENTS</li>
								<li>UNLIMITED DISK SPACE</li>
