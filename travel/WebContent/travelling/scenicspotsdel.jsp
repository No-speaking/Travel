			    ...
			    <div class="col-md-6">
			        <div class="panel panel-default">
			            <div class="panel-heading">
			                <h2><i class="fa fa-indent red"></i><strong>删除景点</strong></h2>
			            </div>
			            <form action="deletescenic.action" method="post" enctype="multipart/form-data" class="form-horizontal ">
						<div class="panel-body">
							
				                
				                <div class="form-group">
				                    <label class="col-md-3 control-label" for="text-input">景点名称</label>
				                    <div class="col-md-9">
				                        <input type="text" id="text-input" name="sm.scenicname" class="form-control" placeholder="Text" value="${sm.scenicname }"  readonly="readonly">
				                        <span class="help-block">This is a help text</span>
				                    </div>
				                </div>
                                
                                <div class="form-group">
				                    <label class="col-md-3 control-label" for="textarea-input">介绍</label>
				                    <div class="col-md-9">
				                        <textarea id="textarea-input" name="sm.scenicintr" rows="9" class="form-control" placeholder="Content.."  readonly="readonly">${sm.scenicintr }</textarea>
				                    </div>
				                </div>
                                
				                <div class="form-group">
				                    <label class="col-md-3 control-label" for="email-input">门票</label>
				                    <div class="col-md-9">
				                        <input type="text" id="email-input" name="sm.scenicticket" class="form-control" placeholder="Email address" value="${sm.scenicticket }"  readonly="readonly">
				                ...
				                <div class="form-group">
				                    <label class="col-md-3 control-label" for="password-input">营业时间</label>
				                    <div class="col-md-9">
				                        <input type="text" id="password-input" name="sm.scenictime" class="form-control" placeholder="Password"  value="${sm.scenictime }"  readonly="readonly">
                                ...
                                <div class="form-group">
				                    ...
				                    <div class="col-md-9">
				                        <img data-src="holder.js/100%x200" alt="100%x200" name="photo" src="show.action?scenicname=${sm.scenicname }" id="file-input"  data-holder-rendered="true" style="height: 200px; width: 100%; display: block;">
				                    </div>
				                </div>
