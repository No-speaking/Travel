			    ...
			    <div class="col-md-6">
			        <div class="panel panel-default">
			            <div class="panel-heading">
			                <h2><i class="fa fa-indent red"></i><strong>增加景点</strong></h2>
			            </div>
			            <s:form action="addscenic.action" method="post" enctype="multipart/form-data" class="form-horizontal ">
						<div class="panel-body">
				                ...
				                <div class="form-group">
				                    ...
				                    <div class="col-md-9">
				                        <s:textfield id="text-input" name="sm.scenicname" cssClass="form-control" placeholder="Text" theme="simple"/>
                                ...
                                <div class="form-group">
				                    ...
				                    <div class="col-md-9">
				                        <s:textarea id="textarea-input" name="sm.scenicintr"  cssClass="form-control"  theme="simple"></s:textarea>
				                    </div>
				                </div>
				                ...
				                <div class="form-group">
				                    ...
				                    <div class="col-md-9">
				                        <s:textfield id="email-input" name="sm.scenicticket" cssClass="form-control" placeholder="Email address" theme="simple"/>
				                ...
				                <div class="form-group">
				                    ...
				                    <div class="col-md-9">
				                        <s:textfield id="password-input" name="sm.scenictime" cssClass="form-control"  theme="simple"/>
				                        <span class="help-block">Please enter a complex password</span>
				                    </div>
				                </div>
                                
                                <div class="form-group">
				                    <label class="col-md-3 control-label" for="file-input">选择图片</label>
				                    <div class="col-md-9">
