		...
		<div class="main ">
			...
			<div class="row">
				...
				<div class="price-table">	
					...
					<div class="price-table three">
						
						<div class="plan">
							<ul>
								<li class="header red-bg"> ${rm.routename}</li>								
								<li class="price">${rm.routeprice}</li>								
                                <li>${rm.routeintro}</li>
                                <li>天数:${rm.routeday}</li>
                                <li>交通方式:${rm.routetraffic}</li>
								<li><s:checkboxlist label="景点" name="scenics" list="sml" listKey="scenicname" listValue="scenicname" value="scenics"></s:checkboxlist></li>
