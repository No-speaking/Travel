...
<body>
	...
	<div class="container-fluid content">
		...
		<div class="main sidebar-minified">
			...
			<div class="row">
				<div class="col-lg-12">
					<h3 class="page-header"><i class="fa fa-table"></i>路线</h3>
					<ol class="breadcrumb">
						<li><i class="fa fa-home"></i><a href="index.html">主页</a></li>			  	
						<li><i class="fa fa-table"></i>路线</li>				
					</ol>
				</div>
			</div>
				...
				<div class="col-lg-12">
					<div class="panel panel-default">
						<div class="panel-heading">
							<h2><i class="fa fa-table red"></i><span class="break"></span><strong>路线</strong></h2>
						...
						<div class="panel-body">
							<table class="table table-striped table-bordered bootstrap-datatable datatable">
							  ...
							  <c:forEach var="rml" items="${rml}">	 
								<tr>
									<td> ${rml.routename} </td><!-- -->
                                    <td>${rml.routeintro}</td>
                                    <td>${rml.routeday}</td>
                                    <td>${rml.routeprice}</td>
                                    
									<td>
										<span class="label label-warning">${rml.routetraffic}</span>
									</td>
									<td>
										<a class="btn btn-success" href="toviewroad.action?routename=${rml.routename }">
											<i class="fa fa-search-plus "></i>                                            
										</a>
										<a class="btn btn-info" href="tomodifyroad.action?routename=${rml.routename }">
											<i class="fa fa-edit "></i>                                            
										</a>
										<a class="btn btn-danger" href="todeleteroad.action?routename=${rml.routename }">
